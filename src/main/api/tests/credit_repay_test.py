...
class TestCreditRequest:
    def test_credit_repay(self, api_manager: ApiManger, create_credit_user_request: CreateCreditUserRequest, db_session: Session, create_account_credit_user, credit_create):
        ...
        credit_repay_request = RandomModelGenerator.generate(CreditRepayRequest, creditId=credit_create.creditId, accountId=create_account_credit_user.id, amount=credit_create.amount)
